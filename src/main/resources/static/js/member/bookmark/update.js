...
const updateBtn = (id, memberId) => {
  updateParams.name = document.querySelector("#alias").value;
  if (!isValidUpdateParams(updateParams)) {
    alert('수정 정보가 올바르지 않습니다.');
    return;
  }
